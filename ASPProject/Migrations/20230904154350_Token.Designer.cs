...
namespace ASPProject.Migrations
{
    ...
    [Migration("20230904154350_Token")]
    partial class Token
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPProject.Entities.Token", b =>
                {
            ...
            modelBuilder.Entity("ASPProject.Entities.Comment", b =>
                {
                    b.HasOne("ASPProject.Entities.User", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASPProject.Entities.Theme", "Theme")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("ASPProject.Entities.Rate", b =>
                {
                    b.HasOne("ASPProject.Entities.Section", null)
                        .WithMany("Rates")
